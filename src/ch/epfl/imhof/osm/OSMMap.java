...
public final class OSMMap {
    ...
    public static class Builder {
        ...
        /**
         * Returns a node of the future <code>OSMMap</code> given its id or
         * <code>null</code> if no node corresponds to the given id.
         * 
         * @param id
         *            the wanted node's identifiction (<code>long</code>)
         * 
         * @return the node of the future <code>OSMMap</code> given its id or
         *         <code>null</code> if any node corresponds to the given id
         */
        ...
        /**
         * Returns a way of the future <code>OSMMap</code> given its id or
         * <code>null</code> if no way corresponds to the given id.
         * 
         * @param id
         *            the wanted way's identification (<code>long</code>)
         * 
         * @return the way of the future <code>OSMMap</code> given its id or
         *         <code>null</code> if no way corresponds to the given id
         */
        ...
        /**
         * Returns a relation of the future <code>OSMMap</code> given its id or
         * <code>null</code> if no relation corresponds to the given id.
         * 
         * @param id
        ...
        /**
         * Returns a new <code>OSMMap</code> instance using the data provided to
         * the <code>OSMMap.Builder</code>.
         * 
